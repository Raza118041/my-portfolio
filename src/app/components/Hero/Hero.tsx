...
const Hero = () => {
    return (
        <section
            className='relative overflow-hidden bg-gray-50 py-12 px-4 sm:px-6 md:px-8 lg:py-16 lg:px-20 flex flex-col lg:flex-row items-center justify-between'
        >
            <div
                className='flex-1 lg:ml-28 w-full max-w-xl space-y-6 relative z-20'
            >
                ...
                >
                    ...
                    <span className='font-bold text-black block lg:inline'>
                        Service<span className='text-green-500 rounded-full'>.</span>
                    </span>
                </h2>
                ...
                <div className='flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-80 items-center lg:items-start'>
                    <div 
                    data-aos='zoom-in'
                    data-aos-delay="200"
                    className='bg-white w-72 rounded-3xl p-6 border border-gray-100 shadow-xl lg:shadow-2xl transition'>
                        ...
                        <p className='ml-4 text-gray-500 text-sm mt-2'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. In id perspiciatis nulla quam! Possimus officia cum facere odio molestiae deleniti corporis ipsam.
                        </p>
                    </div>
                    <div
                    data-aos='zoom-in'
